...
class CloneDetectionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        # Tokenize the pair of code snippets; no padding applied here.
        ...
        # Squeeze to remove the batch dimension; dynamic padding will be applied later.
...
def main():
    ...
    val_dataset = CodeCloneDataset(valid_file, tokenizer, sample_ratio=1.0)
